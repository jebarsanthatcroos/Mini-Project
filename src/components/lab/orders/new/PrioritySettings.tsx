...
import { PrioritySettingsProps } from '@/types/lab';
      ...
      <div className='space-y-4'>
              ...
              return (
                ...
                >
                  <div className='flex items-center'>
                    <Icon
                      className={`w-5 h-5 mr-2 ${option.color.split(' ')[0]}`}
                    />
        ...
        <div className='flex items-center justify-between p-4 border border-gray-200 rounded-lg'>
          ...
          <label className='relative inline-flex items-center cursor-pointer'>
            <input
              ...
              onChange={e =>
                onOrderDataChange({ isCritical: e.target.checked })
              }
        ...
        <div className='bg-blue-50 border border-blue-200 rounded-lg p-4'>
          ...
          <ul className='text-sm text-blue-800 space-y-1'>
            <li>
              • <strong>LOW:</strong> Routine checkups, annual exams
            </li>
            <li>
              • <strong>NORMAL:</strong> Most diagnostic testing
            </li>
            <li>
              • <strong>HIGH:</strong> Emergency department, inpatient
            </li>
            <li>
              • <strong>STAT:</strong> Life-threatening conditions
            </li>
          </ul>
        </div>
      </div>
