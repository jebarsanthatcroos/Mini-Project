        ...
        <div className="container px-4 mx-auto">
          <div className="-mx-4 flex flex-wrap justify-between">
            ...
            <div className="px-4 my-4 w-full xl:w-1/5 text-left"> 
              <Logo />
              <p className="text-justify pb-4 mb-4 ">
            ...
            <div className="px-4 my-4 w-full sm:w-auto text-left"> 
              ...
              <ul className="leading-8">
                <li><Link href="/app" className="hover:text-blue-400">Home</Link></li>
                <li><Link href="/my-cart" className="hover:text-blue-400">My Cart</Link></li>
            ...
            <div className="px-4 my-4 w-full sm:w-auto text-left"> 
              <div>
                <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-600">Address</h2>
        ...
        <div className="container mx-auto px-4">
          <div className="-mx-4 flex flex-wrap justify-between">
            <div className="px-4 w-full text-left sm:w-auto"> 
              <p>&copy; {currentYear} Developed and Designed by |
                <a href="mailto:gwu-hict-2021-42@gwu.ac.lk" className="text-white hover:text-blue-400"> jebarsanthatcroos</a>
              </p>
            </div>
          </div>
        </div>
