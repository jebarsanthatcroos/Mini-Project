...
export function useAuth() {
  ...
  return {
    ...
    features: {
      ...
      canViewPatients: ["ADMIN", "DOCTOR", "NURSE", "RECEPTIONIST"].includes(user?.role || ""),
      canManageAppointments: ["ADMIN", "DOCTOR", "NURSE", "RECEPTIONIST"].includes(user?.role || ""),
      canAccessMedicalRecords: ["ADMIN", "DOCTOR", "NURSE"].includes(user?.role || ""),
