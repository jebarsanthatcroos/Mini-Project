...
export const canAccess = (userRole: UserRole, requiredRole: UserRole | UserRole[]): boolean => {
...
export const getRolePermissions = (role: UserRole) => {
  const permissions = {
    ...
    canViewPatients: ["ADMIN", "DOCTOR", "NURSE", "RECEPTIONIST"].includes(role),
    canManageAppointments: ["ADMIN", "DOCTOR", "NURSE", "RECEPTIONIST"].includes(role),
