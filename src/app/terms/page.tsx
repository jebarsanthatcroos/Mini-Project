...
import { FaUserShield, FaFileContract, FaBalanceScale } from 'react-icons/fa';
              ...
              <div className='bg-white rounded-2xl shadow-lg p-8'>
                ...
                <section id='introduction' className='mb-12'>
                  ...
                  <div className='space-y-4 text-gray-700'>
                    <p>
                      Welcome to <strong>jebarsanthatcroos</strong>{' '}
                      (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;).
                    ...
                    <p>
                      ...
                      by these Terms and our Privacy Policy. If you disagree
                ...
                <section id='content' className='mb-12'>
                  ...
                  <div className='space-y-4 text-gray-700'>
                    ...
                    <p>
                      You retain ownership of any content you create or share
                      through our services. By posting content, you grant us a
                ...
                <section id='privacy' className='mb-12'>
                  ...
                  <div className='space-y-4 text-gray-700'>
                    ...
                    <p>
                      ...
                      responsible for taking precautions to protect your
                ...
                <section id='liability'>
                  ...
                  <div className='space-y-4 text-gray-700'>
                    ...
                    <p>
                      ...
                      not guarantee that our services will be uninterrupted or
                      error-free.
                    </p>
                    ...
                    <p>
                      You agree to indemnify and hold harmless jebarsanthatcroos
                      and its affiliates from any claims, damages, or expenses
                ...
                <section className='mt-12 pt-8 border-t border-gray-200'>
                  <div className='bg-gray-50 rounded-lg p-6'>
                    ...
                    <p className='text-gray-700'>
                      ...
                      notify you of significant changes by posting the new Terms
