      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
            <h2 className="text-xl font-semibold text-red-800 mb-2">Error Loading Pharmacy</h2>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => router.push(`/Pharmacist/pharmacy/${pharmacy._id}/edit`)}
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4">
                <h1 className="text-3xl font-bold text-gray-900 mb-2 sm:mb-0">{pharmacy.name}</h1>
                <span
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-gray-600 mt-1">{pharmacy.pharmacistName}</p>
                </div>
                <div>
                  <h3 className="font-medium text-gray-900">License Number</h3>
                  <p className="text-gray-600 mt-1 font-mono">{pharmacy.licenseNumber}</p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-3 text-sm">
                ...
                {pharmacy.emergencyContact && (
                  <div>
                    ...
                    <span className="text-gray-600 ml-2">{pharmacy.emergencyContact}</span>
                  </div>
                )}
                <div>
                  <span className="font-medium text-gray-900">Created By:</span>
                  <span className="text-gray-600 ml-2">{pharmacy.createdBy.name}</span>
                </div>
                <div className="flex items-center gap-2 text-gray-600">
                  <FiCalendar className="w-4 h-4" />
                  <span>Added on {new Date(pharmacy.createdAt).toLocaleDateString()}</span>
                </div>
                <div>
