                      ...
                      <div className="bg-white rounded-2xl shadow-lg p-8">
                          ...
                          <section id="introduction" className="mb-12">
                              ...
                              <div className="space-y-4 text-gray-700">
                                  <p>
                                      At <strong>jebarsanthatcroos</strong>, we are committed to protecting your privacy
                          ...
                          <section id="data-sharing" className="mb-12">
                              ...
                              <div className="space-y-4 text-gray-700">
                                  ...
                                  <p>
                                      We may share information with third-party vendors and service providers who
                          ...
                          <section id="cookies" className="mb-12">
                              ...
                              <div className="space-y-4 text-gray-700">
                                  ...
                                  <p>
                                      ...
                                      your browser to remove or reject browser cookies. Please note that if you choose to
                              ...
                              <div className="space-y-4 text-gray-700">
                                  ...
                                  <div className="grid md:grid-cols-2 gap-4 mt-4">
                                      <div className="bg-gray-50 p-4 rounded-lg">
                                          ...
                                          <p className="text-sm">Right to access and update your personal information</p>
                                      </div>
                                      ...
                                      <div className="bg-gray-50 p-4 rounded-lg">
                                          ...
                                          <p className="text-sm">Right to request deletion of your personal data</p>
                                      </div>

                                      <div className="bg-gray-50 p-4 rounded-lg">
                                          <h4 className="font-semibold text-gray-900 mb-2">Data Portability</h4>
                                          <p className="text-sm">Right to receive your data in a portable format</p>
                                      </div>

                                      <div className="bg-gray-50 p-4 rounded-lg">
                                          <h4 className="font-semibold text-gray-900 mb-2">Objection</h4>
                                          <p className="text-sm">Right to object to certain data processing activities</p>
                                      </div>
                                  </div>
                          ...
                          <section id="security">
                              ...
                              <div className="space-y-4 text-gray-700">
                                  ...
                                  <p>
                                      ...
                                      to be 100% secure. We cannot promise or guarantee that hackers, cybercriminals, or
                          ...
                          <section className="mt-12 pt-8 border-t border-gray-200">
                              <div className="bg-gray-50 rounded-lg p-6">
                                  ...
                                  <div className="text-sm text-gray-600">
                                      ...
                                      <p className="mt-1">We will respond to your request within 30 days.</p>
                                  </div>

                                  <h3 className="font-semibold text-gray-900 mt-6 mb-2">Policy Updates</h3>
