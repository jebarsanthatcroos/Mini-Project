...
export default function ProfilePage() {
  ...
  useEffect(() => {
    if (user) {
      setFormData({
        ...
        bio: user.bio || "Healthcare professional dedicated to providing excellent patient care."
      });
    }
  }, [user]);
  ...
  const getRoleBadge = (role: string) => {
    ...
    return (
      <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${roleColors[role as keyof typeof roleColors] || roleColors.USER}`}>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {(user.role === "DOCTOR" || user.role === "NURSE" || user.role === "LABTECH" || user.role === "PHARMACIST") && (
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
