        ...
        <div className="bg-white rounded-lg shadow-sm p-8 text-center">
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-6 text-left">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-gray-700">Order confirmation sent to your email</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="bg-purple-100 p-2 rounded-full">
                  <FiPackage className="text-purple-600 text-sm" />
                </div>
                <span className="text-sm text-gray-700">Our pharmacist will verify your prescription</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="bg-green-100 p-2 rounded-full">
                  <FiShoppingBag className="text-green-600 text-sm" />
                </div>
                <span className="text-sm text-gray-700">Order will be prepared for pickup/delivery</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
            ...
            <p className="text-sm text-yellow-700">
              Prescription orders typically take 30-60 minutes to process. You&apos;ll receive a notification when your order is ready.
            </p>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <p className="text-sm text-gray-600">
              ...
              <a href="tel:+94123456789" className="text-blue-600 hover:underline">
                +94 123 456 789
              </a>
            </p>
          </div>
