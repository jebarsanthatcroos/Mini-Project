...
import { FiSearch, FiPlus, FiEdit, FiTrash2, FiFilter, FiPackage, FiX, FiAlertCircle } from 'react-icons/fi';
...
export default function PharmacistShopPage() {
  ...
  const categories = ['Prescription', 'OTC', 'Supplements', 'Medical Devices', 'Personal Care', 'Other'];
  ...
  const getStockStatus = (product: Product) => {
    ...
    if (product.stockQuantity <= product.minStockLevel) {
      return { text: 'Low Stock', color: 'text-yellow-600 bg-yellow-50 border-yellow-200' };
    }
        ...
        >
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            <div>
              ...
              <p className="text-gray-600 mt-2">Manage your pharmacy products efficiently</p>
            </div>
            <motion.button
